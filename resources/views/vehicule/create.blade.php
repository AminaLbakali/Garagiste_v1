            ...
            <div class="p-4">
                ...
                <form action="{{ route('vehicule.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="flex items-center justify-center ">
                        <h2 class="text-3xl font-bold text-center text-indigo-600 mb-8">Ajoute Véhicule</h2>
                      </div>                    <div class="mb-4">
                        <label for="Marque" class="block text-gray-700 font-bold mb-2">Marque:</label>
                        <input type="text" name="Marque" id="Marque" required class="form-input w-full h-10 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200">
                    </div>
                    <div class="mb-4">
                        <label for="Modele" class="block text-gray-700 font-bold mb-2">Modèle:</label>
                        <input type="text" name="Modele" id="Modele" required class="form-input w-full h-10 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200">
                     </div>
                    <div class="mb-4">
                        <label for="Type_carburant" class="block text-gray-700 font-bold mb-2 ">Type de carburant :</label>
                        <select id="Type_carburant" name="Type_carburant" class="form-select w-full  border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 h-10" required>
                    ...
                    <div class="mb-4">
                        <label for="numero_immatriculation" class="block text-gray-700 font-bold mb-2 ">Numéro d'immatriculation:</label>
                        <input type="text" name="numero_immatriculation" id="numero_immatriculation" required class="form-input w-full h-10 border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 h-10 ">
                    </div>
                    <div class="mb-4">
                        <label for="Picture" class="block text-gray-700 font-bold mb-2">Picture</label>
                        <input type="file" name="Picture" id="Picture" class="form-input w-full border-gray-300 h-10 mb-5 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 h-10">
                    <button type="submit" class="block text-white bg-indigo-500 hover:bg-indigo-600 font-bold py-2 px-4 rounded">Submit</button>
                </form>
            </div>
        </div>
    </div>
