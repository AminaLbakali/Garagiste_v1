    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-dashed rounded-lg dark:border-gray-700 mt-14 bg-indigo-100">
            ...
            <div class="container mx-auto px-4 py-8 max-w-lg ">
                <h2 class="text-3xl font-bold text-center text-indigo-700 mb-10 ">Edit Vehicle</h2>
                ...
                <form action="{{ route('vehicule.update', $vehicule->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div>
                        <label for="Marque" class="text-indigo-600">Marque:</label>
                        <input type="text" name="Marque" id="Marque" value="{{ $vehicule->Marque }}"
                            class="block w-full border border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-indigo-600"
                            required>
                    </div>
        
                    <div>
                        <label for="Modele" class="text-indigo-600">Modèle:</label>
                    ...
                    <div>
                        <label for="Type_carburant" class="text-indigo-600">Type de carburant:</label>
                        <input type="text" name="Type_carburant" id="Type_carburant"
                    ...
                    <div>
                        <label for="numero_immatriculation" class="text-indigo-600">Numéro d'immatriculation:</label>
                        <input type="text" name="numero_immatriculation" id="numero_immatriculation"
                    ...
                    <div>
                        <label for="Picture" class="text-indigo-600">Photo:</label>
                        <input type="file" name="Picture" id="Picture"
                            class="block border-gray-300 rounded-md px-3 py-2 mt-1 focus:outline-none focus:border-indigo-600">
                        @if ($vehicule->picture)
                        <img src="{{ asset($vehicule->picture) }}" alt="Vehicle Photo" class="mt-2 max-w-xs">
                        @endif
                    </div>
        
                    <button type="submit"
                    class="
                     w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline transform transition-all duration-150 ease-in-out">
                        Update
                    </button>
                </form>
            </div>
