    ...
    <div class="p-4 sm:ml-64">
        <div class="p-4 border-dashed rounded-lg dark:border-gray-700 mt-14 bg-indigo-100">
            <div class="p-4">
                ...
                @endif
                <form action="{{ route('clients.store') }}" method="POST" enctype="multipart/form-data" class="max-w-lg mx-auto my-10 bg-white p-8 rounded-xl shadow-2xl">
                    @csrf
                    <div class="flex items-center justify-center">
                        <h2 class="text-3xl font-bold text-center text-indigo-600 mb-8">Ajouter Client</h2>
                    </div>
                    <div class="mb-4">
                        <label for="nom" class="block text-gray-700 font-bold mb-2">Nom:</label>
                        <input type="text" name="nom" id="nom" required class="form-input w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 h-8">
                    </div>
                    <div class="mb-4">
                        <label for="prenom" class="block text-gray-700 font-bold mb-2">Prénom:</label>
                        <input type="text" name="prenom" id="prenom" required class="form-input w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 h-8">
                    </div>
                    <div class="mb-4">
                        <label for="adresse" class="block text-gray-700 font-bold mb-2">Adresse:</label>
                        <input type="text" name="adresse" id="adresse" required class="form-input w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 h-8">
                    </div>
                    <div class="mb-4">
                        <label for="numero_telephone" class="block text-gray-700 font-bold mb-2">Numéro de téléphone:</label>
                        <input type="text" name="numero_telephone" id="numero_telephone" required class="form-input w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 h-8">
                    </div>
                    <div class="mb-4">
                        <label for="adresse_email" class="block text-gray-700 font-bold mb-2">Adresse e-mail:</label>
                        <input type="email" name="adresse_email" id="adresse_email" required class="form-input w-full border-gray-300 rounded-md shadow-sm focus:border-indigo-500 focus:ring focus:ring-indigo-200 h-8">
                    </div>
                    <button type="submit" class="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline transform transition-all duration-150 ease-in-out">Enregistrer</button>
                </form>
            </div>
        </div>
    </div>
