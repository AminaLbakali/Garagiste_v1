...
<body class="">
   <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
      ...
      <div class="flex items-center justify-center h-screen ">
          <div class="max-w-lg w-full mx-auto p-8 bg-white bg-opacity-90 rounded-2xl shadow-2xl">
              <h1 class="text-3xl font-bold text-center text-indigo-700 mb-10">Modifier Client</h1>
  
              <form action="{{ route('clients.update', $client->id) }}" method="POST" class="space-y-6 animate-fade-in-up">
                  @csrf
                  @method('PUT')
                  ...
                  <div class="group">
                      ...
                      <input type="text" name="nom" id="nom" placeholder="Nom" value="{{ $client->nom }}" required
                          class="mt-2 p-3 block w-full rounded-md border border-transparent focus:border-indigo-500 focus:bg-white focus:ring-0 transition duration-300 ease-in-out group-hover:shadow-lg">
                  </div>
                  ...
                  <div class="group">
                      ...
                      <input type="text" name="prenom" id="prenom" placeholder="Prénom" value="{{ $client->prenom }}" required
                          class="mt-1 p-3 block w-full rounded-md border border-transparent focus:border-indigo-500 focus:bg-white focus:ring-0 transition duration-300 ease-in-out group-hover:shadow-lg">
                  </div>
                  ...
                  <div class="group">
                      <label for="numero_telephone" class="block text-sm font-semibold text-gray-700">Numéro de téléphone</label>
                  ...
                  <div class="group">
                      <label for="adresse_email" class="block text-sm font-semibold text-gray-700">Adresse e-mail</label>
                      <input type="email" name="adresse_email" id="adresse_email" placeholder="Adresse e-mail" value="{{ $client->adresse_email }}" required
                          class=" mt-1 p-3 block w-full rounded-md border border-transparent focus:border-indigo-500 focus:bg-white focus:ring-0 transition duration-300 ease-in-out group-hover:shadow-lg">
                  </div>
  
                  <button type="submit"
                      class="w-full bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline transform transition-all duration-150 ease-in-out">
                      Enregistrer
                  </button>
              </form>
          </div>
