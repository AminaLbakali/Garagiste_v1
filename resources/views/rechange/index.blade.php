    ...
    <body>
      ...
      <nav class="fixed top-0 z-50 w-full bg-white border-b border-gray-200 dark:bg-gray-800 dark:border-gray-700">
        ...
        <div class="p-4 sm:ml-64">
          <div id="search-container" class="p-4 border-dashed rounded-lg dark:border-gray-700 mt-14">
              <div class="container mx-auto py-8">
                  ...
                  <a href="{{ route('pieces-rechange.create') }}" class="inline-block bg-indigo-500 mb-4 w-48 bg-gradient-to-r mt-4 from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-bold py-3 px-4 rounded-lg focus:outline-none focus:shadow-outline transform transition-all duration-150 ease-in-out">
                      <i class="fa-solid fa-screwdriver-wrench mr-2"></i>Ajouter pièce</a>
                  <div class="overflow-x-auto">
                      <table class="min-w-full bg-white rounded-lg shadow-md overflow-hidden">
                          ...
                          <tbody>
                              ...
                              <tr class="searchable-item border-b border-gray-200 hover:bg-gray-100">
                                  <td class="py-3 px-6 text-indigo-700 font-medium">{{ $piece->nom }}</td>
                                  <td class="py-3 px-6 text-gray-600">{{ $piece->reference }}</td>
                                  <td class="py-3 px-6 text-gray-600">{{ $piece->stock }}</td>
                                  <td class="py-3 px-6">
                                      <a href="{{ route('pieces-rechange.show', $piece->id) }}" class="text-indigo-500 hover:underline">Details</a>
                                  </td>
                              </tr>
                              @endforeach
                          </tbody>
